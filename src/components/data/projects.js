...
const projects = [
  {
    ...
    summary: ['Adopte Une Série est un projet développé from scrach en un mois par une équipe de 4 développeurs (2 front et 2 back) en total remote, dans le cadre d\'un projet de fin de formation.',
