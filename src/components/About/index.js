...
const About = () => (
  <AboutStyled>
    ...
    <div id="aboutMe">
      ...
      <p>
        Mes apétences pour la programmation et la créativité m'ont naturellement emmené vers le métier
        de développeur web.
      </p>
      <p>
        Je me suis donc embarquée en octobre 2019 dans une formation de développeur fullstack
        au sein de l'école O'clock (labelisée Grande Ecole du Numérique). Un parcours sous admission
      ...
      <p>
        ...
        au web mais pas seulement, je le trouve également dans :
      </p>
      <div id="hobbies">
      ...
      <Document file="CV.pdf"> Pour en savoir plus.</Document>
    </div>
  </AboutStyled>
);
